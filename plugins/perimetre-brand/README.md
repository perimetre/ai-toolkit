...
**What it covers:**
- Colour palette: Carbon (`#111111`), Steel (`#737678`), Aqua *(name TBC)* (`#13FADC`)
...
| Name | HEX | Role |
|------|-----|------|
| Carbon | `#111111` | Primary text, dark backgrounds |
| Steel | `#737678` | Secondary text, borders, captions |
| Aqua *(name TBC)* | `#13FADC` | Accent, highlights, CTAs |

## Version History

| Version | Notes |
|---------|-------|
| 1.0.0 | Initial release — colours, typography, logo usage |
