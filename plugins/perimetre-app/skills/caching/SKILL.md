...
name: caching
description: >
  Périmètre caching strategies for Next.js apps. Use when implementing data caching,
  revalidation, ISR, or reviewing caching logic. Covers Next.js fetch cache, React.cache,
  unstable_cache, on-demand revalidation, and cache tags.
---
