---
name: payload-drizzle
description: >
  Périmètre Payload CMS + Drizzle ORM integration patterns. Use when accessing the
  database directly via Drizzle in a Payload CMS project, running migrations, or
  reviewing Payload/Drizzle usage. Covers the shared drizzle instance and migration workflow.
---
