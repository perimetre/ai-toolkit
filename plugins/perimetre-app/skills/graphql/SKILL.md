...
name: graphql
description: >
  Périmètre GraphQL patterns with TanStack Query and code generation. Use when writing
  GraphQL queries/mutations, running codegen, or reviewing GraphQL usage. Covers
  graphqlOptions factory, codegen setup, fragment usage, and cache invalidation.
---
