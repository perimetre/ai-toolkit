...
name: seo
description: >
  Périmètre SEO patterns for Next.js apps. Use when implementing metadata, Open Graph,
  structured data, sitemap generation, or reviewing SEO-related code. Covers the
  generateMetadata API, canonical URLs, og:image, JSON-LD, and robots.txt.
---
