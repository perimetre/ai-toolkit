...
name: images
description: >
  Périmètre Next.js Image component patterns. Use when adding images, implementing
  responsive photos, or reviewing Image usage. Covers width/height requirements,
  fill with relative parent, sizes prop, priority for LCP images, and alt text i18n.
---
