...
name: icons
description: >
  Périmètre icon patterns using @perimetre/icons. Use when adding icons, building icon
  components, or reviewing icon usage. Covers the Icon wrapper component, currentColor,
  aria-hidden vs label, and avoiding Next.js Image for SVGs.
---
