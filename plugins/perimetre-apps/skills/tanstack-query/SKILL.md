...
name: tanstack-query
description: >
  Périmètre TanStack Query patterns for server state management. Use when implementing
  data fetching, mutations, cache invalidation, or reviewing query code. Covers
  queryOptions factory pattern, prefetching in RSC, and cache invalidation after mutations.
---
