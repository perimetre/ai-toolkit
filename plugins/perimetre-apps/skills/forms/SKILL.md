...
name: forms
description: >
  Périmètre form patterns using React Hook Form and Zod. Use when building forms,
  implementing validation, or reviewing form code. Covers single shared schema pattern,
  zodResolver, field registration, error display, and i18n for error messages.
---
