...
name: error-handling
description: >
  Périmètre error-as-values pattern for TypeScript/Node.js apps. Use when implementing
  error handling, try-catch blocks, service layer errors, or reviewing error propagation.
  Covers custom error classes, ok/error return types, and error boundaries.
---
